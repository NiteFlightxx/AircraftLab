...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMinimumSnapWaypointAndContinuityTest,
	"AircraftAutopilot.Trajectory.MinimumSnap.WaypointsAndContinuity",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMinimumSnapWaypointAndContinuityTest::RunTest(const FString& Parameters)
{
	UMinSnapTrajectorySegment* Segment = NewObject<UMinSnapTrajectorySegment>();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMinimumSnapMotionLimitsTest,
	"AircraftAutopilot.Trajectory.MinimumSnap.RespectsMotionLimits",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMinimumSnapMotionLimitsTest::RunTest(const FString& Parameters)
{
	UMinSnapTrajectorySegment* Segment = NewObject<UMinSnapTrajectorySegment>();
	const FTrajectoryRequest Request = MakeMinimumSnapRequest();
	FString Error;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMinimumSnapGeneratorIntegrationTest,
	"AircraftAutopilot.Trajectory.MinimumSnap.NativeTimeGeneratorIntegration",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMinimumSnapGeneratorIntegrationTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FMinimumSnapMovementIntentIntegrationTest,
	"AircraftAutopilot.Movement.MinimumSnapPathIntent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMinimumSnapMovementIntentIntegrationTest::RunTest(const FString& Parameters)
{
