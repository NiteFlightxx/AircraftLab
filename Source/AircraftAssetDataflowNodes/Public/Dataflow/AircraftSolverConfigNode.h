...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Solver|Iterations")
	bool bOverrideIterationCounts = false;

	/** 位置求解迭代：影响穿透、静摩擦和约束位置稳定性。 */
	UPROPERTY(EditAnywhere, Category = "Solver|Iterations", meta = (EditCondition = "bOverrideIterationCounts", ClampMin = "0", ClampMax = "255"))
