...
public:
	...
	/** 作者维护的可增减 LOD 输入；已连接 Pin 的顺序就是运行时 LOD 顺序。 */
	UPROPERTY()
	...
	virtual bool CanRemovePin() const override { return !CollectionLods.IsEmpty(); }
...
private:
	...
	TArray<TSharedRef<const FManagedArrayCollection>> GetConnectedCollectionLodValues(
